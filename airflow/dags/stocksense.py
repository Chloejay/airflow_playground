...
from airflow.operators.postgres_operator import PostgresOperstor 
...
def _fetch_pageviews(pagename, ts_nodash, execution_date, **_):
    result = dict.fromkeys(pagename, 0)
...
write_to_postgres= PostgresOperstor(
